...
// let result1 = link.includes("https://");
// let fnc = (y) => {
//   if (y === result1 ){
//     return "კი მოიცავს";
//   } return "არ მოიცავს";
...
// });
// console.log(array6);
// ..... \ ეს ვარიანტი შეიძლება ქვემოთ რაც მაქვს აღწერილი იმის შესამოწმებლად მასივსი მაქვს თუ არა 
// დადებიტი რიცხვი ?
// let array00 = [-1, -2, -3, 4].some((item) => {
//     if (item > 0){
//      console.log(item);
//     }
//  })
